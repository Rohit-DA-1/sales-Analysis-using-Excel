...
🥇 East Region generated the highest revenue — focused marketing and distribution appears to be a key driver
📅 August and October were peak sales months — strong seasonal demand worth leveraging in future campaigns
...
Double down on East Region — study what's working and replicate it in Central, which underperforms
Pre-load inventory before August and October — seasonal peaks are predictable and can be planned for
Prioritise Monitor and Camera in marketing spend — highest revenue generators deserve more visibility
Investigate December decline — check for supply chain delays, pricing changes, or demand shifts specific to that period![Screenshot 2025-04-28 202213](https://github.com/user-attachments/assets/a3896af6-890e-498f-94c4-68f3dc64fd6c)
